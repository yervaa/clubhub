...
export function ClubPageStickyActions({ href, label, visible }: ClubPageStickyActionsProps) {
  ...
  return (
    <>
      <div
        className="fixed inset-x-0 bottom-0 z-40 border-t border-slate-200/90 bg-white/95 px-3 pt-2.5 shadow-[0_-6px_24px_rgba(15,23,42,0.08)] backdrop-blur-sm lg:hidden"
